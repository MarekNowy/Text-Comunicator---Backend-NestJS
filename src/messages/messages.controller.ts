...
// new endpoint
    ...
    schema: {
      ...
      items: {
        ...
        properties: {
          ...
          receiverId: { type: 'string', example: 'fbe388e2-28fd-4427-92ff-79531f5593a6' },
          senderId: { type: 'string', example: '13fc7f3a-e49f-453a-9f99-883d62e51ac7' },
          content: { type: 'string', example: 'Hi :)' },
          sentAt: { type: 'string', format: 'date-time', example: '2025-03-20T13:03:47.052Z' },
        }
      },
      example: [
        {
  ...
  @ApiResponse({
    ...
    schema: {
      ...
      content: { type: 'string', example: 'Hi :)' },
      sentAt: { type: 'string', format: 'date-time', example: '2025-03-20T13:03:47.052Z' },
      partnerId: { type: 'string', example: 'fbe388e2-28fd-4427-92ff-79531f5593a6' },
